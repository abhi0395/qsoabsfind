...
- **Emission lines**: blue side - Lyα forest edge (1310 Å), red side - C IV (1549.5 Å)
- **Search window**:
...
- **Emission lines**: blue side - O VI λ1032, red side - Lyα (1215.67 Å)
- **Search window**:
...
- **Emission lines**: blue side - Lyα (1215.67 Å), red side - C IV (1549.5 Å)
- **Search window**:
...
- **Emission lines**: blue side - C IV (1549.5 Å), red side - Al III (1858.8 Å)
- **Search window**:
...
- **Emission lines**: blue side - Al III (1858.8 Å), red side - Mg II (2799.1 Å)
- **Search window**:
